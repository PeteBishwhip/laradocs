...
[macro engine](/docs/content/macros): `<x-name>` resolves to the macro
...
[Registering your own](/docs/content/macros#registering-your-own):
...
[GitHub-style alert blockquote](/docs/content/rich-content) instead.
