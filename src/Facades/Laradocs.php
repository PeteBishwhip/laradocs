 ...
 * @method static \Laradocs\Laradocs onChat(Closure $handler)
 * @method static \Laradocs\Laradocs chatContext(Closure $resolver)
 * @method static \Laradocs\Laradocs chatTools(Closure $resolver)
 * @method static \Laradocs\Laradocs chatAuthorize(?Closure $callback)
