...
return [
    ...
    */
    ...
    'openapi' => [
        ...
        'request_body' => 'Órgano de Solicitud',
        ...
        'circular' => 'Referencia circular',
        'unresolved' => 'Referencia no resuelta',
        'default_tag' => 'Otros',

        // Redesigned reference UI.
        'copy' => 'Copiado',
        'copy_endpoint' => 'Punto final de copia',
        'base_url' => 'Base URL',
        'version' => 'Versión',
        'resources' => 'Recursos',
        'request' => 'Petición',
        'response' => 'Respuesta',
        'language' => 'Idioma',
        'code_samples' => 'Ejemplos de solicitudes y respuestas',
        ...
        'endpoint_count' => '{1} :count punto final|[2,*] :count puntos finales',
    ],
